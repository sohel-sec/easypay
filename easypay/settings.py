...
SECRET_KEY = 'django-insecure-znwd@ne_*wx3pe@(ay^_r$o!yy1tt46e5-5l995+0q+8^fkw6n'
...
# Cores header settings 

# CORS_ALLOWED_ORIGINS = [
#     '*'
# ]

# # Optional: Allow all HTTP methods (GET, POST, PUT, DELETE, etc.)
